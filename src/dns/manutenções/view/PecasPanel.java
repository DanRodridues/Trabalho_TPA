...
public class PecasPanel extends javax.swing.JPanel
{
    ...
    private void initComponents()
    {
        ...
        add(BotaoExcluir, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 80, 120, 62));
        ...
        add(BotaoSalvar, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 150, 120, 60));
    ...
    {//GEN-HEADEREND:event_BotaoAlterarActionPerformed
        if(control.ctrlPecas().validarCODIGO(TextoCodigo.getText()))
        {
            ...
            TextoPreço.setText(String.valueOf(control.ctrlPecas().getPrecoPecas(TextoCodigo.getText())));
            TextoValor.setText(String.valueOf(control.ctrlPecas().getValorPecas(TextoCodigo.getText())));
        }
        else
        {
