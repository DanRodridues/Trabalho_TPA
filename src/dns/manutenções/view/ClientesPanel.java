...
public class ClientesPanel extends javax.swing.JPanel
{
    ...
    {//GEN-HEADEREND:event_BotaoExcluirActionPerformed
        ...
        if(control.ctrlClientes().validarCPF(TextoCpf.getText()))
        {
            control.ctrlClientes().ExcluirPessoa(control.ctrlClientes().getPessoa(TextoCpf.getText()));
            listModel.removeElement(control.ctrlClientes().getNomePessoas(TextoCpf.getText()));
            this.atualizarLista();
